			...
			<Modal
				...
				<View style={styles.overlay}>
					<View style={styles.sheet}>
							...
							<TouchableOpacity
								...
								<Text
									style={[
										...
										!isELI5 && styles.togglePillTextActive,
									]}>
									Normal
								</Text>
							</TouchableOpacity>
						...
						{isELI5 && (
							<Text style={styles.eli5Hint}>
								Explain Like I'm 5 — for the chronically confused
							</Text>
						)}
						...
						<ScrollView showsVerticalScrollIndicator={false}>
							{instructions.map((item, i) => (
								<View key={`${isELI5}-${i}`} style={styles.instructionRow}>
									<Text
										style={[styles.instructionNum, isELI5 && { color: RED }]}>
										{i + 1}
									</Text>
