...
export default function WordRevealScreen({ navigate, gameState }) {
  ...
  const handleNext = async () => {
    ...
    if (isLastPlayer) {
      ...
      navigate('playerReveal', { ...gameState, currentPlayerIndex: currentPlayerIndex + 1 });
    }
  };
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.content}>
          ...
          <View style={styles.center}>
            {isImposter && (
              <Animated.Text style={[styles.imposterBadge, { opacity: fadeAnim }]}>
            ...
            >
              ...
              <Text style={[styles.word, isImposter && styles.wordImposter]}>
            ...
            {isImposter && (
              <Animated.Text style={[styles.blendInHint, { opacity: fadeAnim }]}>
